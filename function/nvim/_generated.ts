 ...
 *     Namespace id, or -1
 */
export function nvim_get_hl_ns(denops: Denops, opts: unknown): Promise<unknown>;
export function nvim_get_hl_ns(
  denops: Denops,
  ...args: unknown[]
): Promise<unknown> {
  return denops.call("nvim_get_hl_ns", ...args);
}
 ...
 * can check if the TUI is running by inspecting the client name of each UI:
 *
 ...
 */
export function nvim__complete_set(
  denops: Denops,
  index: unknown,
  opts: unknown,
): Promise<unknown>;
export function nvim__complete_set(
  ...
  return denops.call("nvim__complete_set", ...args);
}
 ...
 *     its argument.
 */
export function nvim__id_dict(denops: Denops, dct: unknown): Promise<unknown>;
export function nvim__id_dict(
  denops: Denops,
  ...args: unknown[]
): Promise<unknown> {
  return denops.call("nvim__id_dict", ...args);
}
 ...
 */
export function nvim__invalidate_glyph_cache(denops: Denops): Promise<unknown>;
export function nvim__invalidate_glyph_cache(
  denops: Denops,
  ...args: unknown[]
): Promise<unknown> {
  return denops.call("nvim__invalidate_glyph_cache", ...args);
}
 ...
 *   - `:redraw`
 */
export function nvim__redraw(denops: Denops, opts: unknown): Promise<unknown>;
export function nvim__redraw(
  denops: Denops,
  ...args: unknown[]
): Promise<unknown> {
  return denops.call("nvim__redraw", ...args);
}
 ...
 */
export function nvim__ns_get(denops: Denops, ns_id: unknown): Promise<unknown>;
export function nvim__ns_get(
  denops: Denops,
  ...args: unknown[]
): Promise<unknown> {
  return denops.call("nvim__ns_get", ...args);
}
...
export function nvim__ns_set(
  ...
  return denops.call("nvim__ns_set", ...args);
}
 ...
 */
export function nvim_win_text_height(
  denops: Denops,
  window: unknown,
  opts: unknown,
): Promise<unknown>;
export function nvim_win_text_height(
  ...
  return denops.call("nvim_win_text_height", ...args);
}
 ...
 */
export function nvim_tabpage_set_win(
  denops: Denops,
  tabpage: unknown,
  win: unknown,
): Promise<unknown>;
export function nvim_tabpage_set_win(
  ...
  return denops.call("nvim_tabpage_set_win", ...args);
}
 ...
 *   - **{value}**  Event payload
 */
export function nvim_ui_term_event(
  denops: Denops,
  event: unknown,
  value: unknown,
): Promise<unknown>;
export function nvim_ui_term_event(
  ...
  return denops.call("nvim_ui_term_event", ...args);
}
