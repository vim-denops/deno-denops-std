 ...
 *     {command}  Ex-command string
 */
export function nvim_command_output(
  denops: Denops,
  command: unknown,
): Promise<unknown>;
export function nvim_command_output(
  ...
  return denops.call("nvim_command_output", ...args);
}
 ...
 */
export function nvim_execute_lua(
  denops: Denops,
  code: unknown,
  args: unknown,
): Promise<unknown>;
export function nvim_execute_lua(
  ...
  return denops.call("nvim_execute_lua", ...args);
}
